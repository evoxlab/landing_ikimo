                                                   ...
                                                   <div>
                                                      ...
                                                      <ul class="init" style="padding-top: 0px !important;">
                                                         <li>
                                                            ...
                                                            ?>
                                                            <a style="color:<?php echo $color; ?>!important;font-size: 10px;" class="btn btn-sm fs-9 py-1 px-1" href="#" onclick="show_info('<?php echo $obj_customer['name']; ?>', '<?php echo $obj_customer['lastname']; ?>', '<?php echo $obj_customer['code']; ?>','<?php echo $obj_customer['country'];?>');" data-bs-toggle="modal" data-bs-target="#kt_modal_info"><?php echo $obj_customer['code']; ?><br/><?php echo $obj_customer['name']; ?></a>
                                                            <!------------->
                                                            <!--//NIVEL 2-->
                                                            <!------------->
                                    ...
                                    <div class="modal-content" id="modal-content-structure">
                                       ...
                                       <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                          <form>
                                             ...
                                             <div class="py-2 d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                                   <span>Kit de Afiliación</span>
                                                </label>
                                                <input type="text" name="i_affiliation_kit" id="i_affiliation_kit" class="form-control form-control-solid" readonly>
                                             </div>
                                             <div class="py-2 d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                                   <span>Rango</span>
